...
function validateHotelEntry(hotel) {
  if( hotel.name && hotel.address && hotel.city && hotel.state && hotel.zip && hotel.phone
    && hotel.website && hotel.email && hotel.ownerid && hotel.rating && hotel.cost ) {
      return 1;
  }
  else { return 0; }
}
